                          ...
                          <div class="col-md-6">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-t-0 m-b-30">Editar perfil</h4>
                                            <form class="form-horizontal"  method="POST" action="{{url('perfiles/'.$perfil->id)}}" id="frm_perfiles" onsubmit="return validateFrm();">
                                            {{ csrf_field() }}
                                            {{ method_field('PUT') }}
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Nombre del Perfil</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="perfil" name="perfil" placeholder="Capture el nombre del perfil" valida="SI" cadena ="- Debe capturar el nombre del perfil" value="{{$perfil->perfil}}">
                                                    </div>
                                                </div>
